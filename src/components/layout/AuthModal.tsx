        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: "0 32px 80px rgba(140,82,255,0.18), 0 8px 32px rgba(0,0,0,0.08)",
              padding: "36px 32px 28px",
              overflow: "hidden",
            }}
          >
            {/* Purple gradient accent top strip */}
            <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
              <div style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                boxShadow: "0 8px 24px rgba(140,82,255,0.30)",
              }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
              {SSO_BUTTONS.map(({ id, label, Icon, bg, border, color, hoverBg }) => (
                <button
                  key={id} id={id}
                  /* SSO PLACEHOLDER — wire real OAuth handler here */
                  onClick={() => {}}
                  style={{
                    display: "flex", alignItems: "center", justifyContent: "center",
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.background = hoverBg; (e.currentTarget as HTMLButtonElement).style.transform = "translateY(-1px)"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.background = bg; (e.currentTarget as HTMLButtonElement).style.transform = "translateY(0)"; }}
                >
                  <Icon size={16} />
                  {label}
                </button>
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
              ...
              <button
                id="auth-email-continue"
                onClick={() => {}}
                className="btn-primary"
                style={{ padding: "12px 16px", borderRadius: 12, gap: 6, flexShrink: 0 }}
              >
