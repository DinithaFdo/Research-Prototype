...
const STATS = [
  { value: "96.3%", label: "Detection Accuracy", sub: "DeBERTa-v3 ensemble" },
  {
    ...
    sub: "4-branch adaptive fusion",
  },
  {
    value: "84.7",
    label: "AOPC Faithfulness",
    sub: "Explanation quality metric",
  },
  {
    value: "<1.2s",
    label: "Processing Latency",
    sub: "Per document inference",
  },
];
      ...
      >
        ...
        >
          <span
            ...
            style={{ fontSize: 11, padding: "6px 16px", gap: 8 }}
          >
            <span
              className="pulse-dot"
        ...
        >
          An enterprise-grade AI forensics platform unifying text and voice
          authenticity verification through explainable deep learning and
